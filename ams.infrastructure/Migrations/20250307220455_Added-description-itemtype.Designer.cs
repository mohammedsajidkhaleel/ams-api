...
namespace ams.infrastructure.Migrations
{
    ...
    [Migration("20250307220455_Added-description-itemtype")]
    partial class Addeddescriptionitemtype
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ams.domain.PurchaseOrders.PurchaseOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ams.domain.PurchaseOrders.PurchaseOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ams.domain.PurchaseOrders.PurchaseOrderItem", b =>
                {
                    ...
                    b.HasOne("ams.domain.PurchaseOrders.PurchaseOrder", "PurchaseOrder")
                        .WithMany("Items")
